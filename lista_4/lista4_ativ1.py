...
def desempate():
    if valor_maior_poke == cp_max and lista_nome[i] != maior_poke:
        empate += 1
...
if empate == 0:
    ...
    print(f'Foi uma análise difícil, mas o Pokémon vencedor com maior CP é: {maior_poke}, com CP máximo de {valor_maior_poke:.2f}')